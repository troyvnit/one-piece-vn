Ext.define('OnePiece.view.Gallery', {
    ...
    config: {
        ...
        items: [
        {
            ...
            items: [
                {
                    html: '<img src="http://genk2.vcmedia.vn/t9oZPEuV08CBD85xeOiS2oJTnt4TN/Image/2014/05/ava-c370a.png" style="width: 100%"/>',
                    style: 'background: #000'
                },
                {
                    html: '<img src="http://cartoonpacks.com/wp-content/uploads/2014/05/one_piece_hd_pictures.jpg" style="width: 100%" />',
                    style: 'background: #000'
                }
            ]
        }
